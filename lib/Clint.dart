...
class ClintPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Clint - Stardew Valley Wiki'),
    ...
    return ExpansionTile(
      ...
      children: <Widget>[
        _buildScheduleTable('Kış - 15', [
          ['9:00 ÖÖ', 'Demirci tezgahının arkasında'],
          ['4:00 ÖS', 'Demirciyi Gece Pazarına gitmek için dükkanı bırakır.'],
          ['12:00 ÖS', 'Demirci geri döner.'],
        ]),
        _buildScheduleTable('Kış - 16', [
          ['9:00 ÖÖ', 'Demirci tezgahın arkasında.'],
          ['10:30 ÖÖ', 'Harvey\'nin Sağlık Ocağı\'na gitmek için Demirciden çıkar'],
          ['1:30 ÖS', 'Klinikte bekleme odasından muayene odasına geçiş yapar.'],
          ['4:00 ÖS', '	Klinikten çıkıp Salona gider.'],
          ['12:00 ÖS', 'Eve döner.'],
        ]),
        _buildScheduleTable('Düzenli Takvim', [
          ['9:00 ÖÖ', 'Demirci tezgahı arkasında.'],
          ['4:00 ÖS', 'Tezgahtan çıkıp örsün başına geçer.'],
          ['7:20 ÖS', 'Demirciden çıkar ve Salona gider.'],
          ['12:00 ÖS', 'Salondan çıkar ve eve gider.'],
        ]),
      ],
    );
  }
    ...
    return ExpansionTile(
      ...
      children: <Widget>[
        _buildScheduleTable('Yağmurlu Gün', [
          ['9:00 ÖÖ', 'Demirci tezgahının arkasında.'],
          ['4:30 ÖS', 'Tezgahtan ayrılır ve örsün başına geçer.'],
          ['7:00 ÖS', 'Demirciden çıkar ve Salona doğru gider.'],
          ['12:00 ÖS', 'Salon çıkar ve eve gider.'],
        ]),

        _buildScheduleTable('Cuma (Halkevi Restore Edilmişse', [
          ['8:50 ÖÖ', 'Evden çıkar Topluluk Merkezi kazan dairesine gider.'],
          ['5:00 ÖS', 'Topluluk Merkezinden çıkar ve Salona gider.'],
          ['12:00 ÖS', 'Salondan çıkar ve eve gider.'],
        ]),
      ],
    );
