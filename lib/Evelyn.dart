...
class EvelynPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Evelyn - Stardew Valley Wiki'),
  ...
  Widget _buildImage() {
    return Center(
      child: Image.network(
        'https://stardewvalleywiki.com/mediawiki/images/0/04/Evelyn.png',
        width: 128,
        height: 128,
      ),
    );
  ...
  Widget _buildSpringSchedule() {
    return ExpansionTile(
      ...
      children: <Widget>[
        _buildScheduleTable('Her Mevsimin 2si', [
          ['8:00 ÖÖ', 'Mutfağında oyalanır.'],
          ['10:30 ÖÖ', 'Sağlık ocağına gitmek için evinden ayrılır.'],
          ['1:30 ÖS', 'Soldaki muayene odasına gider.'],
          ['4:00 ÖS', 'Sağlık ocağından ayrılır, mutfağına gider.'],
          ['7:00 ÖS', 'Oturma odasında kitaplığın önünde durur.'],
          ['9:30 ÖS', 'Uyumak için yatağına gider.'],
        ]),
        _buildScheduleTable('Her Mevsimin 23ü', [
          ['8:00 ÖÖ', 'Mutfağında oyalanır.'],
          ['10:40 ÖÖ', 'Evden ayrılır. Kocası Georgela birlikte Sağlık Ocağına gider.'],
          ['1:30 ÖS', 'Georgela birlikte soldaki muayene odasına gider.'],
          ['4:10 ÖS', 'Sağlık ocağından ayrılır, mutfağına gider.'],
          ['7:00 ÖS', 'Oturma odasında kitaplığın önünde durur.'],
          ['9:30 ÖS', 'Uyumak için yatağına gider.'],
        ]),
        _buildScheduleTable('Kış Mevsiminin 17.günü', [
          ['8:00 ÖÖ', 'Mutfağında oyalanır.'],
          ['10:40 ÖÖ', 'Georgela Televizyon izler.'],
          ['12:10 ÖS', 'Yemek masasının yanında duruyor.'],
          ['1:00 ÖS', 'Evinde bekler.'],
          ['4:30 ÖS', 'Akşam Pazarına gider.'],
          ['11:40 ÖS', 'Uyumak için yatağına gider.'],
        ]),
        _buildScheduleTable('Yağmurlu Günler', [
          ['8:00 ÖÖ', 'Mutfağında oyalanır.'],
          ['10:40 ÖÖ', 'Georgela Televizyon izler.'],
          ['12:10 ÖS', 'Yemek masasının yanında duruyor.'],
          ['4:30 ÖS', 'Mutfak tezgahının yanında duruyor.'],
          ['7:00 ÖS', 'Oturma odasında kitaplığın önünde durur.'],
          ['9:30 ÖS', 'Uyumak için yatağına gider.'],
        ]),
        _buildScheduleTable('Pazartesi, Perşembe ve Cumartesi(Halkevi onarılmışsa)', [
          ['8:00 ÖÖ', 'Mutfağında oyalanır.'],
          ['10:40 ÖÖ', 'Georgela Televizyon izler.'],
          ['12:10 ÖS', 'Zanaat Odasındaki koltuğa oturmak için Halkevine gider'],
          ['4:30 ÖS', 'Mutfak tezgahının yanında duruyor.'],
          ['7:00 ÖS', 'Oturma odasında kitaplığın önünde durur.'],
          ['9:30 ÖS', 'Uyumak için yatağına gider.'],
        ]),
        _buildScheduleTable('Yaz Boyunca', [
          ['8:00 ÖÖ', 'Mutfağında oyalanır.'],
          ['10:40 ÖÖ', 'Georgela Televizyon izler.'],
          ['12:10 ÖS', 'Yemek masasının yanında duruyor.'],
          ['1:00 ÖS', 'Kasabadaki bitkilerle ilgilenmeye gidiyor.'],
          ['4:30 ÖS', 'Mutfak tezgahının yanında duruyor.'],
          ['7:00 ÖS', 'Oturma odasında kitaplığın önünde durur.'],
          ['9:30 ÖS', 'Uyumak için yatağına gider.'],
        ]),
